...
public class ApexSwagger {
    ...
    public ApexSwagger() {
        try {
            File file = new File("apex_swagger_log.txt");
    ...
    public static void RunApexSwagger(String[] args, IProgressMonitor monitor) {
        ...
        if (monitor != null) {
            ...
            monitor.beginTask("ApexSwagger - documenting your Apex Class files.", (files.size() / 2) * 3 + 2);
        }
    ...
    private static void printHelp() {
        System.out.println("ApexSwagger - a tool for generating Swagger documentation from Salesforce Apex code class files.\n");
        System.out.println("    Invalid Arguments detected.  The correct syntax is:\n");
        System.out.println("ApexSwagger -s <source_directory> [-t <target_directory>] [-g <source_url>] [-h <homefile>] [-a <authorfile>] [-p <scope>]\n");
        ...
        System.out.println("<source_url> - Optional. Specifies a URL where the source is hosted (so ApexSwagger can provide links to your source).");
    ...
    public static ClassModel parseFileContents(String filePath) {
        try {
            ...
            while ((strLine = br.readLine()) != null) {
                ...
                // ignore anything after // style comments. this allows hiding of tokens from ApexSwagger.
